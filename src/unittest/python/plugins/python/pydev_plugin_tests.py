...
from test_utils import MagicMock, Mock, call, patch

from pybuilder.core import Project
from pybuilder.plugins.python.pydev_plugin import init_pydev_plugin, pydev_generate
...
class PydevPluginTests(unittest.TestCase):
    ...
    def test_should_write_pydev_files(self, os, mock_open):
        ...
        self.assertEqual(
            metadata_file.write.call_args_list,
            [
                call(
