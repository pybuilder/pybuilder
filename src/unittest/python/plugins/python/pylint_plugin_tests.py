...
class PylintPluginTests(TestCase):
    ...
    def test_should_check_that_pylint_can_be_executed(self, mock_assert_can_execute):
        ...
        check_pylint_availability(mock_project, mock_logger)

        expected_command_line = ('pylint',)
        mock_assert_can_execute.assert_called_with(expected_command_line, 'pylint', 'plugin python.pylint', env=ANY)
