...
class ReportsProcessorTests(unittest.TestCase):
    ...
    @patch(
        "pybuilder.plugins.python.test_plugin_helper.render_report",
    ...
    def test_should_parse_reports(self):
        reports = [
            {"test": "name1", "test_file": "file1", "success": False, "time": 1},
            {"test": "name2", "test_file": "file2", "success": False, "time": 2},
            {"test": "name3", "test_file": "file3", "success": True, "time": 3},
